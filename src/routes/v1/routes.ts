...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { RegisterWithFacebook } from './../../controllers/userControllers/facebook.controller';
...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":8388608}});
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v5/users/facebook',
            ...(fetchMiddlewares<RequestHandler>(RegisterWithFacebook)),
            ...(fetchMiddlewares<RequestHandler>(RegisterWithFacebook.prototype.FacebookConsentScreen)),

            async function RegisterWithFacebook_FacebookConsentScreen(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    redirect: {"in":"res","name":"302","required":true,"dataType":"void"},
            };
            ...
            try {
                ...
                const controller = new RegisterWithFacebook();
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v5/users/sigin/facebook/callback',
            ...(fetchMiddlewares<RequestHandler>(RegisterWithFacebook)),
            ...(fetchMiddlewares<RequestHandler>(RegisterWithFacebook.prototype.handleFacebookCallback)),

            async function RegisterWithFacebook_handleFacebookCallback(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    badRequest: {"in":"res","name":"400","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string","required":true}}},
                    internalServerError: {"in":"res","name":"500","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string","required":true}}},
